...
export const SkillChipUI = (props: Props) => {
  ...
  const color = props.tooltipIdentifier ? 'primary' : 'default'
  return <Chip sx={{ m: '4px' }} className={styles.container} icon={icon} color={color} label={props.title} onClick={tooltipOnClick}></Chip>
}
